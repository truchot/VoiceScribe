...
final class ConversationCoach {
    ...
    // Output types are now standalone Domain types in Domain/Models/CoachingOutputModel.swift:
    // CoachingOutput, ActionSuggestion, SlotStatus, TransitionNudge, ActiveTip, EmotionCoaching
